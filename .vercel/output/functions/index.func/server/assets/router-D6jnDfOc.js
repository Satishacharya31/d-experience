import { Q as reactExports, t as functionalUpdate$1, a as arraysEqual, g as createLRUCache, E as isPromise, F as isRedirect, C as isNotFound, y as invariant, f as createControlledPromise, _ as rootRouteId, G as isServer$1, d as compileDecodeCharMap, a0 as trimPath, Z as rewriteBasepath, e as composeRewrites, P as processRouteTree, N as processRouteMasks, Y as resolvePath, c as cleanPath, a2 as trimPathRight, M as parseHref, o as executeRewriteInput, z as isDangerousProtocol, S as redirect, s as findSingleMatch, j as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, b as buildRouteBranch, x as interpolatePath, L as nullReplaceEqualDeep, U as replaceEqualDeep$1, J as last, i as decodePath, q as findFlatMatch, r as findRouteMatch, w as hasKeys, p as executeRewriteOutput, l as encodePathLikeUrl, a1 as trimPathLeft, H as joinPaths, a4 as useRouter, k as dummyMatchContext, K as matchContext, W as requireReactDom, n as exactPathTest, T as removeTrailingSlash, R as React, I as jsxRuntimeExports, B as isModuleNotFoundError, a3 as useHydrated, m as escapeHtml, A as isInlinableStylesheet, u as getAssetCrossOrigin, X as resolveManifestAssetLink, O as Outlet } from "./server-BtD0xwrV.js";
...
const appCss = "/assets/styles-BAdIxQGa.css";
...
const $$splitComponentImporter = () => import("./index-BdZmhor7.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "An immersive WebGL terminal — experiments in rendering, systems and late-night code by Satish."
    }, {
      property: "og:title",
      content: "THE_LAB // satish.com.np"
    }, {
